...
class FaceRecognitionSystem:
    def __init__(self,root):
        ...
        photo_label.place(x=50,y=585,width=220,height=40)
        ...
        photo_label.place(x=550,y=585,width=220,height=40)
        ...
        photo_label.place(x=1030,y=585,width=200,height=40)
