...
class Student:
    def __init__(self,root):
        ...
        # img10 = img10.resize((1250,70), Image.ANTIALIAS)
        # self.photoImg10 = ImageTk.PhotoImage(img10)
        # bg_lbl1=Label(self.root,image=self.photoImg10)
        # bg_lbl1.place(x=0,y=0,width=1250,height=70)
        ...
        Manage_std_frame=Frame(self.root,bd=2,relief=RIDGE,bg="black")
        Manage_std_frame.place(x=0,y=50,width=1250,height=600)

        # ==================== Project title ==================================================
        title=Label(self.root,text="SMART ATTENDENCE SYSTEM",font=("times new roman",40,"bold"),bg="black",fg="white")
        title.place(x=0,y=0,width=1250,height=50)

        # myname=Label(self.root,text="Developed Raj",fg="black",bg="white",font=("times new roman",18,"bold"))
        ...
        lbl = Label(title, font = ('times new roman',16, 'bold'),background = 'black',foreground = 'white') 
        lbl.place(x=0,y=(-15),width=120,height=50) 
        time()

        # =======Framedetails===================================================================================
        
        DataFrameLeft=LabelFrame(Manage_std_frame,bd=4,padx=2,relief=RIDGE,fg="white",bg="black",
                                                font=("arial",12,"bold"),text="Student Information ")
        DataFrameLeft.place(x=10,y=15,width=650,height=570)

        #  ================Right labelframe=================
        DataFrameRight=LabelFrame(Manage_std_frame,bd=4,padx=2,relief=RIDGE,bg="black",fg="white",
                                                font=("arial",12,"bold"),text="Student Details")
        DataFrameRight.place(x=680,y=10,width=600,height=580)

        img30 = Image.open("college_images/1.jpg")
        img30 = img30.resize((680,120), Image.ANTIALIAS)
        self.photoImg30 = ImageTk.PhotoImage(img30)
        myimg=Label(DataFrameLeft,image=self.photoImg30,bd=2,relief=RIDGE)
        myimg.place(x=0,y=(-0),width=680,height=80)

        img20 = Image.open("college_images/12.jpg")
        img20 = img20.resize((570,200), Image.ANTIALIAS)
        ...
        std_Info_label_frame=LabelFrame(DataFrameLeft,padx=10,bd=2,relief=RIDGE,font=("times new roman",11,"bold"),fg="green",bg="white",text="Current Course Information")
        std_Info_label_frame.place(x=1,y=80,width=680,height=115)
        ...
        com_dep['value']=("Select Department","COMPUTER SCIENCE ENGINEERING","MECHANICAL ENGINEERING","CIVIL ENGINEERING","ELECTRONICS & COMMUNICATION ENGINEERING","ELECTRICAL ENGINEERING","INFORMATION TECHNOLOGY")
        com_dep.current(0)
        ...
        com_txtcourse_std=ttk.Combobox(std_Info_label_frame,textvariable=self.var_course,state="readonly",
                                                        font=("arial",12,"bold"),width=17)
        com_txtcourse_std['value']=("Select Course","B.Tech","MCA","MBA","B.Com")
        ...
        com_txt_currunt_year=ttk.Combobox(std_Info_label_frame,textvariable=self.var_year,state="readonly",
                                                        font=("arial",12,"bold"),width=17)
        com_txt_currunt_year['value']=("Year","2022-2023","2023-2024","2024-2025","2025-2026")
        ...
        std_personalData_label_frame.place(x=1,y=195,width=680,height=260)
        ...
        com_txt_div['value']=("Select Division","A","B","E")
        ...
        lbl_teacher=Label(std_personalData_label_frame,font=("arial",12,"bold"),text="Faculty Name:",bg="white")
        ...
        radiobtn1=ttk.Radiobutton(std_personalData_label_frame, text="Take Photo", value="Yes", variable=self.usertype)
        radiobtn1.grid(row=5, column=0,pady=10)

        radiobtn2=ttk.Radiobutton(std_personalData_label_frame, text="No Photo", value="No", variable=self.usertype)
        ...
        ButtonFrame1.place(x=0,y=450,width=680,height=38)

        ButtonFrame2=Frame(DataFrameLeft,bd=3,relief=RIDGE)
        ButtonFrame2.place(x=0,y=485,width=680,height=38)

        # ===================================ButtonFrame=====================================
        btnAddData=Button(ButtonFrame2,text="UPDATE",command=self.std_update,font=("arial",11,"bold"),width=23,bg="black",fg="white")
        ...
        btnPhoto=Button(ButtonFrame1,text="SAVE STUDENT INFO / ADD PHOTO SAMPLE",command=self.generate_dataset,font=("arial",13,"bold"),width=72,bg="black",fg="white")
        ...
        # =======table&search=====================================================================================
        Table_frame=LabelFrame(DataFrameRight,text="View Student Details & Search System",font=("arial",11,"bold"),bg="black",bd=3,relief=RIDGE)
        Table_frame.place(x=0,y=200,width=570,height=70)

        # ==========Search By========
        lblSearch=Label(Table_frame,font=("arial",11,"bold"),text="Search By",padx=2,bg="white",fg="black")
        ...
        search_combo['values']=("Select Option","Mob. No.","Roll","Department")
        ...
        btnReset=Button(title,text="Back",command=self.go_back,font=("arial",15,"bold"),width=15,bg="black",fg="white")
        ...
        if (self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_roll.get()=="" or self.usertype.get()==""):
            ...
            try:
                ...
                if update>0:
                    ...
                    if not update:
                        return
                messagebox.showinfo("Success","Student Updation Successfully Completed....!!!",parent=self.root)                                                                                                                   
                conn.commit()
                self.fetch_data()
                self.clear()
                conn.close()                                                                                                                                                                   
    ...
    def std_delete(self):
        if self.ref_id.get()== 0:
            messagebox.showerror("Error","Reference Id must be required",parent=self.root)
        else:
