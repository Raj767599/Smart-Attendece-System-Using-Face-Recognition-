...
class ChatBot: 
    def __init__(self,root):
        ...
        img_chat=Image.open(r"college_images\help.png")
        img_chat=img_chat.resize((200,70),Image.ANTIALIAS)
        self.photoimg_chat=ImageTk.PhotoImage(img_chat)


        Title_label=Label(main_frame,bd=3,relief=RAISED,anchor='nw',width=730,image=self.photoimg_chat,compound=LEFT,text="CHAT ME",font=("arial",30,'bold'),fg='green',bg="black")
        ...
        btn_frame=Frame(self.root,bd=3,relief=RAISED,bg='black',width=730)
        btn_frame.pack()

        label=Label(btn_frame,text="Type Something",fg='green',bg='black',font=("arial",14))
        ...
        self.send=Button(btn_frame,text="Send->>",command=self.send,width=8,bg="green",fg="black",font=("times new roman",16))
        self.send.grid(row=0,column=2,sticky=W)
        

        self.clear=Button(btn_frame,text="Clear Chat ",command=self.clear,width=8,bg="red",fg="black",font=("times new roman",15))
        self.clear.grid(row=1,column=0,sticky=W)
        
        self.msg=""
        self.label1=Label(btn_frame,text=self.msg,fg='red',bg='black',font=("arial",14))
