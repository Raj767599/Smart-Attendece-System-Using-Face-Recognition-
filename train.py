...
class Train_Data:
    def __init__(self,root):
        ...
        b3 =Button(self.root,text="TRAIN DATA",command=self.train_classifier,borderwidth=15,font=("times new roman",25,"bold"),bg="lime",activebackground="red",fg="white",cursor="hand2")
        b3.place(x=120,y=380,width=700,height=60)

        # myname=Label(self.root,text="",fg="black",bg="white",font=("times new roman",18,"bold"))
        # myname.place(x=0,y=0)
        
        btnReset=Button(title,text="Back",command=self.go_back,font=("Magneto",11,"bold"),width=17,bg="white",fg="red")
