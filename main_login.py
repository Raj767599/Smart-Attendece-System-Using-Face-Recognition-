...
class Register:
    def __init__(self,root):
        ...
        # ------------------row1
        fname=Label(frame,text="First Name",font=("arial",15,"bold"),bg="yellow",fg="white")
        fname.place(x=50,y=100)

        self.fname_entry=ttk.Entry(frame,textvariable=self.var_fname,font=("arial",15,"bold"))
        self.fname_entry.place(x=50,y=130,width=250)

        l_name=Label(frame,text="Last Name",font=("arial",15,"bold"),bg="yellow",fg="white")
        ...
        contact=Label(frame,text="Contact No",font=("arial",15,"bold"),bg="yellow",fg="white")
        contact.place(x=50,y=170)

        self.txt_contact=ttk.Entry(frame,textvariable=self.var_contact,font=("arial",15,"bold"))
        self.txt_contact.place(x=50,y=200,width=250)

        email=Label(frame,text="Email",font=("arial",15,"bold"),bg="yellow",fg="white")
        ...
        security_Q=Label(frame,text="Select Security Quetions",font=("arial",15,"bold"),bg="yellow",fg="white")
        ...
        security_A=Label(frame,text="Security Answer",font=("arial",15,"bold"),bg="yellow",fg="white")
        ...
        pswd=Label(frame,text="Password ",font=("arial",15,"bold"),bg="yellow",fg="white")
        pswd.place(x=50,y=310)

        self.txt_pswd=ttk.Entry(frame,textvariable=self.var_pass,font=("arial",15,"bold"))
        self.txt_pswd.place(x=50,y=340,width=250)

        confirm_pswd=Label(frame,text="Confirm Password",font=("arial",15,"bold"),bg="yellow",fg="white")
